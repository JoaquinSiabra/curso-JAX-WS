...
public class ClienteServicioHoraPolling {
    ...
    public static void main(String[] args){
        new ClienteServicioHoraPolling().doTest();
    }
    public void doTest(){
        try{
            ...
            Response<Source> oResponseSource = oDispatch.invokeAsync(oSourceReq);
            long nTiempoInicial = (new Date()).getTime();
            while (!oResponseSource.isDone()) {
               Thread.sleep(10);
            }
            ...
            Source oSourceResp = oResponseSource.get();
